         ...
         <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="./sign_up" method="post">
               <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
                  ...
                  <input class="input100" type="text" name="memberName" value="${member.memberName}" >
                  <span class="focus-input100"></span>
               </div>

               <div class="wrap-input100 validate-input m-b-18" data-validate = "Email is required">
                  <span class="label-input100">Email</span>
                  <input class="input100" type="email" name="email" placeholder="${member.email}">
                  <span class="focus-input100"></span>
               </div>
               
               <div class="wrap-input100 validate-input m-b-18" data-validate = "Department is required">
                  <span class="label-input100">Department</span>
                  <input class="input100" type="text" name="memberDepart" placeholder="Enter department">
                  <span class="focus-input100"></span>
               </div>
